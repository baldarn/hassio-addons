...
Total number of addons installed : 0

Top 3 most installed addons :
1. Portainer (2836x)
2. Filebrowser (1961x)
3. Myelectricaldata (490x)
...
&#10003; ![image](https://api.iconify.design/mdi/file-search.svg) [Filebrowser (1961x)](filebrowser/) : filebrowser provides a file managing interface within a specified directory and it can be used to upload, delete, preview, rename and edit your files
...
&#10003; ![image](https://api.iconify.design/mdi/docker.svg) [Portainer (2836x)](portainer/) : Manage your Docker environment with ease
